...
LiquidCrystal_I2C lcd(0x27, 20, 4); //--> Initialize LiquidCrystal with "lcd". lcd(RS,E,D4,D5,D6,D7).


const int PulseWire = A0; //--> PulseSensor PURPLE WIRE connected to ANALOG PIN 0
const int LED_3 = 8; //--> LED to detect when the heart is beating. The LED is connected to PIN 3 on the Arduino UNO.
